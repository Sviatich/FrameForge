      ...
      <section className={`${styles.surface} ${isSidebarCollapsed ? styles.surfaceSidebarCollapsed : ""}`}>
              ...
              >
                ...
                <span className={styles.frameItemAction}>
                  {renderingFrameId === frame.id ? (
                    <LoaderIcon />
                  ) : project?.selectedNodeId === frame.id ? (
                    <ReloadFrameIcon />
                  ) : (
                    <ArrowRightIcon />
                  )}
        ...
        <div className={styles.workspacePane}>
          {activeView === "preview" ? (
            <div className={styles.previewShell}>
              <div className={styles.previewStage}>
                {project ? (
                  ...
                  <EmptyPreview message="Превью станет доступно после выбора frame" />
                )}
              </div>
            </div>
          ) : project ? (
            ...
            <EmptyPreview message="Код станет доступен после выбора frame" />
          )}
        </div>
      </section>
